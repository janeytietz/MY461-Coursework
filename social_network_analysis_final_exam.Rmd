...
library(scales)
#Plot two waves of spendtime - look at plotting examples in the homework to see if there are better ideas for this
...
Question 4 - maybe update this slightly as this is pretty much exactly from the homework
```{r Question 4}
require(igraph)
library("intergraph")
require(intergraph)
